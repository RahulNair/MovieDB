...
#ifndef MOVIEDB_SWIFT_H
#define MOVIEDB_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MovieDB",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7MovieDB11AppDelegate")
...
SWIFT_CLASS("_TtC7MovieDB28LoaderCollectionReusableView")
@interface LoaderCollectionReusableView : UICollectionReusableView
...
SWIFT_CLASS("_TtC7MovieDB25MovieDetailViewController")
@interface MovieDetailViewController : UIViewController
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified titleLabel;
@property (nonatomic, weak) IBOutlet UITextView * _Null_unspecified overviewTextView;
...
SWIFT_CLASS("_TtC7MovieDB12MoviewCVCell")
@interface MoviewCVCell : UICollectionViewCell
...
SWIFT_CLASS("_TtC7MovieDB13SceneDelegate")
...
SWIFT_CLASS("_TtC7MovieDB14ViewController")
@interface ViewController : UIViewController
@property (nonatomic, weak) IBOutlet UICollectionView * _Null_unspecified movieCollectionView;
...
@interface ViewController (SWIFT_EXTENSION(MovieDB)) <UISearchResultsUpdating>
- (void)updateSearchResultsForSearchController:(UISearchController * _Nonnull)searchController;
@end


@interface ViewController (SWIFT_EXTENSION(MovieDB)) <UICollectionViewDataSource, UICollectionViewDelegate>
...
@interface ViewController (SWIFT_EXTENSION(MovieDB)) <UICollectionViewDelegateFlowLayout>
...
- (UIEdgeInsets)collectionView:(UICollectionView * _Nonnull)collectionView layout:(UICollectionViewLayout * _Nonnull)collectionViewLayout insetForSectionAtIndex:(NSInteger)insetForSectionAtsection SWIFT_WARN_UNUSED_RESULT;
